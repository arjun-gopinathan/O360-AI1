...
public class Locators_HrOnboardingPendingPage {
	
	public By hrOnboardingPendingPageHeader = By.xpath("//li[contains(text(),'HR Onboarding Pending')]");
	...
	public By hrOnboardingPendingForm = By.xpath("//h3[normalize-space()='HR Onboarding Pending']");
	...
	public By AddDistributionList_Yes = By.xpath("//label[normalize-space()='Add Distribution List ?']/following-sibling::div/label[1]/input");
	...
	public By requestEmailCreationBtn = By.xpath("//button[normalize-space()='Request Email Creation']");
	public By confirmPreboardingBtn = By.xpath("//button[normalize-space()='Confirm Preboarding']");
	public By JoinMailSentPopup_OkBtn = By.xpath("//button[text()='Ok']");
