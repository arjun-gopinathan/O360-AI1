...
public class AllScenarios_002_HrOnboardingPendingPage extends Base_Class {
...
//				methods_HrOnboardingPendingPage.verifyAutoPopulatedField((String) jsonObject.get("Approved UserName"), locators_HrOnboardingPendingPage.approvedUserName);
				...
				String ssnFilePath = File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "SSN2.pdf";	
				methods_HrOnboardingPendingPage.uploadFileUsingRobot(ssnFilePath);
				methods_HrOnboardingPendingPage.isSSNFileUploadSuccessfull("SSN2.pdf");
				...
				ExtentTestManager.startTest("TC- 12 Update 'Date of Joining' By selecting Another date");
				...
				ExtentTestManager.startTest("TC- 14 Verify 'Parent Office' field Selection");	
				...
				ExtentTestManager.startTest("TC- 15 Click Request Email Creation Button And Navigate To Table");	
				methods_HrOnboardingPendingPage.clickRequestEmailCreationButton();
				...
				ExtentTestManager.startTest("TC- 16 Search the employee and Verify Updated Fields");
				methods_HrOnboardingPendingPage.clickSearchIcon();
				methods_HrOnboardingPendingPage.isSearchDialogOpened();
				methods_HrOnboardingPendingPage.enterCandidateName();
				methods_HrOnboardingPendingPage.clickSearchButton();
				...
				ExtentTestManager.startTest("TC- 17 Verify Suggested Company Email Autofill");
				methods_CreateCandidatePage.verifySuggestedCompanyEmailAutofilled();
				
				ExtentTestManager.startTest("TC- 18 Verify Suggested Company UserName Autofill");
