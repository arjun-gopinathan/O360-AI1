...
import com.Pages_employeeapplicationtrackermodule.Quick_TransferApprovals;
...
public class AllScenarios_Quick_TransferReject extends Base_Class{
	...
	Quick_TransferApprovals Quick_TransferApprovals;
	...
	public void reference() {
		ExcelReader = new com.Utility.ExcelReader("Quick_Transfer_Reject");
		log = new Log();
		...
		Quick_TransferApprovals = new Quick_TransferApprovals();
	...
	public void setupTest(Method method) throws Exception {
		...
		extenttest = ExtentTestManager.startTest(method.getName()).assignCategory("Quick Transfer Reject");		
	}
	...
	public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws IOException, InterruptedException {
		...
		try {
				...
				//	ExtentTestManager.getTest().log(Status.PASS,"Application Login" + com.BasePackage.Base_Class.Pagetitle);
					...
					ExtentTestManager.getTest().log(Status.PASS, "Successfully Logged In");
					 ...
					 handlePopupCovid();
					   ...
					   Quick_TransferApprovals.clickonquickapprovals();
					   //WaitForLoaderToDisappear();
						driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
						ExtentTestManager.startTest("TC-4-Quick Approvals is displayed");
						  ExtentTestManager.getTest().log(Status.PASS,"Quick Approvals is displayed");
						driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
						ExtentTestManager.endTest();
						
					   Quick_TransferApprovals.clickonquicktransferapprovals();
					   driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
						ExtentTestManager.startTest("TC-5-Employee Transfer is displayed under Quick Approvals");
						 ExtentTestManager.getTest().log(Status.PASS,"Employee Transfer is displayed under Quick Approvals");
						driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
						ExtentTestManager.endTest();
						
						Transfer_Approvals.slectempcode(EMPCODE);
						driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
						ExtentTestManager.startTest("TC-6-Searching for EmployeeCode from the list");
						 ExtentTestManager.getTest().log(Status.PASS,"Searching for EmployeeCode from the list");
						driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
						ExtentTestManager.endTest();
					...
					try {
					     ...
					     if (popupElement.isDisplayed()) {
					    	  ...
					    	  Transfer_Approvals.enterapprovercomments(ApproverComments);
								driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
								ExtentTestManager.startTest("TC-7-Approver Comments is enetered");
								...
								driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
								ExtentTestManager.startTest("TC-8-Employee Transfer Request is rejected");
								 ExtentTestManager.getTest().log(Status.PASS,"Employee Transfer Request is rejected");
								driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
								ExtentTestManager.endTest();
			...
			// Logout
			  ...
			  ExtentTestManager.startTest("TC-9-Logout."); context.setAttribute("fileName",
			  "Logout"); 
			  click(userDropDown); 
			  click(L_signout);
