...
public class Allscenerios_Project_Project extends Base_Class{
       ...
       public void reference() {
              ...
              Project_Project  = new Project_Project();
...
//     { 
       ...
       @BeforeMethod
      	public void setupTest(Method method) throws Exception {
      		...
      		extenttest = ExtentTestManager.startTest(method.getName()).assignCategory("Project Project");		
      	}
       ...
       public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws IOException, InterruptedException {
              ...
              try {
                     ...
                     if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
                           ...
                           boolean flag1 = Project_Project.clickOnProjectsubModule(testdata, context);
                           Thread.sleep(1000);
                          // Logout
