...
public class Allscenarios_Project_Client extends Base_Class{
       ...
       public void reference() {
              ...
              Project_Client = new Project_Client();
...
//     { 
   	...
   	public void setupTest(Method method) throws Exception {
   		...
   		extenttest = ExtentTestManager.startTest(method.getName()).assignCategory("Project Client");		
   	}
       ...
       public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws IOException, InterruptedException {
              ...
              try {
                     ...
                     if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
                           ...
                           boolean flag1 = Project_Client.clickOnProjectModule(testdata, context);
                           Thread.sleep(1000);
                           // Logout
