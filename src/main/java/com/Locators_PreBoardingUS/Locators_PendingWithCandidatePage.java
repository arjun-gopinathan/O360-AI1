...
public class Locators_PendingWithCandidatePage {
	
	public By pendingWithCandidatePageHeader = By.xpath("//li[normalize-space()='Pending with Candidate']");
	...
	public By pendingWithCandidateForm = By.xpath("//h3[normalize-space()='Pending with Candidate']");
	...
	//btns
	public By sendReminderBtn = By.xpath("//button[normalize-space()='Send Reminder']");
	public By submitOnBehalfBtn = By.xpath("//button[normalize-space()='Submit On Behalf']");
	public By updateBtn = By.xpath("//button[normalize-space()='Update']");
	
	public By confirmationComment = By.xpath("//textarea[@id='PMOComments']");
	public By okBtn = By.xpath("//button[normalize-space()='Ok']");
