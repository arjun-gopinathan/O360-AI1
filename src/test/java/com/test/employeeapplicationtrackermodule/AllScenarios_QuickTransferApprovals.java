...
public class AllScenarios_QuickTransferApprovals extends Base_Class{
	...
	public void reference() {
		ExcelReader = new com.Utility.ExcelReader("Quick_Transfer_Approvals");
		log = new Log();
	...
	public void setupTest(Method method) throws Exception {
		...
		extenttest = ExtentTestManager.startTest(method.getName()).assignCategory("Quick Transfer Approvals ");		
	}
					...
					ExtentTestManager.getTest().log(Status.PASS, "Successfully Logged In");
					 ...
					 ExtentTestManager.getTest().log(Status.PASS, "Covid Pop Up is Handled");
					   ...
					   driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
						...
						driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
						ExtentTestManager.startTest("TC-6-Employee is selected from the list");
							...
							WebElement popupElement = driver.findElement(PageRepositary.searchedempcode);
						     ...
						     if (popupElement.isDisplayed()) {
						    	  ...
						    	  Transfer_Approvals.enterapprovercomments(ApproverComments);
									...
									Transfer_Approvals.approve();
									driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
									ExtentTestManager.startTest("TC-8-Employee Transfer Request is approved");
