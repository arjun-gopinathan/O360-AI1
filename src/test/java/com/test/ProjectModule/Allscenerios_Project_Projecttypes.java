...
public class Allscenerios_Project_Projecttypes extends Base_Class{
       ...
       Project_Projecttypes Project_Projecttypes;
       ...
       public void reference() {
              ...
              Project_Projecttypes  = new Project_Projecttypes();
...
//     { 
       ...
       @BeforeMethod
      	public void setupTest(Method method) throws Exception {
      		...
      		extenttest = ExtentTestManager.startTest(method.getName()).assignCategory("Project Project types");		
      	}
       ...
       public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws IOException, InterruptedException {
              ...
              try {
                     ...
                     if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
                           ...
                           boolean flag1 = Project_Projecttypes.clickOnProjectsubModule(testdata, context);
                           Thread.sleep(1000);
                          // Logout
