...
//		 click(PageRepositary.clickOnOkButton);
	 ...
	 public boolean CancelLeaveRequestWithDate(String CancelComments ,String leaveType, String fromYear, String fromMonth, String fromDate1, String toYear, String toMonth, String toDate, String duration, String Reason, String Employee) throws InterruptedException 
		{
		...
		//*[contains(text(),'Show More')]
		 ...
		 String xpath = "//span[contains(text(),'" + formattedDate + " - " + formattedDate + "')]/ancestor::div[contains(@class,'d-flex')][1]//img[@title='Cancel Leave']";
		 WaitForLoaderToDisappear();
		 ScrollUntilElementVisible(PageRepositary.CancelLeave);
		 Thread.sleep(1000);
		 click(PageRepositary.ShowMore);  WaitForLoaderToDisappear();Thread.sleep(1000);
		 ScrollUntilElementVisible(PageRepositary.CancelLeave);
		  WebElement element = driver.findElement(By.xpath(xpath)); // Replace with actual XPath
