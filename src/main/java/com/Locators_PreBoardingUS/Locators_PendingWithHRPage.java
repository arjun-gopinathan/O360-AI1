...
public class Locators_PendingWithHRPage {
	
	public By pendingWithHRPageHeader = By.xpath("//li[normalize-space()='Pending with HR']");
	...
	public By pendingWithHRForm = By.xpath("//li[contains(text(),'Pending With HR')]");
	...
	public By approveBtn = By.xpath("//button[normalize-space()='Approve']");
