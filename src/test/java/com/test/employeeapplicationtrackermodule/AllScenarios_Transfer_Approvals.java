...
public class AllScenarios_Transfer_Approvals extends Base_Class{
	...
	public void reference() {
		ExcelReader = new com.Utility.ExcelReader("Transfer_Approvals");
		log = new Log();
	...
	public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws IOException, InterruptedException {
		...
		try {
			...
			// Logout
			  ...
			  ExtentTestManager.startTest("TC-11-Logout."); context.setAttribute("fileName", "Logout"); 
			  click(userDropDown); 
			  click(L_signout);
