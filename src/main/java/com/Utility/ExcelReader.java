...
//		FileInputStream fis = new FileInputStream(".\\src\\test\\resources\\TestData.xlsx");
	...
	public static String getUsernameFromExcel(String filePath, String sheetName, int rowIndex, int cellIndex) {
        ...
        try (FileInputStream fis = new FileInputStream(filePath);
            ...
            if (row != null) {
                username = row.getCell(cellIndex).getStringCellValue();
            }
        } catch (Exception e) {
            System.out.println("Error reading username from Excel: " + e.getMessage());
        }
        return username;
    }
